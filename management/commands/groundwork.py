...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
        ...
        except model_instaces.DoesNotExit:
            ...
            for model_instance in model_instances:
                ...
                f.write(TEMPLATES_LIST % {
                        'modelClass': model_instance._meta.object_name, 'model': model_instance._meta.object_name.lower(), 'app': app})
                f.close()
                ...
                f.write(TEMPLATES_VIEW % {
                        'modelClass': model_instance._meta.object_name,  'model': model_instance._meta.object_name.lower()})
                f.close()
